"""Shared protocol helpers; standard library only."""
import json
import sqlite3
...
VERSION = "0.1.0"
DEFAULT_SETTINGS = {"gap_min": 4, "gap_max": 12, "daily_limit": 1000, "paused": False,
...
def request(url, token, body=None):
    ...
    headers = {"Content-Type": "application/json", "User-Agent": "BARBIE/" + VERSION}
    if token:
